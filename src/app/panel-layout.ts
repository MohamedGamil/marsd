  ...
  renderVariantSwitcher(): string {
    return `
      <div class="variant-switcher">${(() => {
        ...
        return `
            <a href="${vHref('full', 'https://marsd.app')}"
            ...
            <a href="${vHref('tech', 'https://tech.marsd.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://finance.marsd.app')}"
            ...
            <a href="${vHref('happy', 'https://happy.marsd.app')}"
    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          ${variantSwitchEnabled ? this.renderVariantSwitcher() : ''}
          <span class="logo">${appName}</span><span class="logo-mobile">${appName}</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          ${githubLinkEnabled ? `
            <a href="https://github.com/MohamedGamil/marsd" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
        ...
        <div class="header-right">
          ${this.ctx.isDesktopApp || !this.ctx.downloadButtonEnabled ? '' : `<div class="download-wrapper" id="downloadWrapper">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <a class="mobile-menu-item" href="https://x.com/MohamedGamil" target="_blank" rel="noopener">
          ...
          <span class="mobile-menu-item-label">@MohamedGamil</span>
        </a>
        <div class="mobile-menu-divider"></div>
