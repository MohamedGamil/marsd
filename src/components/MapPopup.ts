...
export class MapPopup {
  ...
  private renderMilitaryFlightPopup(flight: MilitaryFlight): string {
    const operatorLabels: Record<string, string> = {
      usaf: t('popups.militaryFlight.operators.usaf'),
      usn: t('popups.militaryFlight.operators.usn'),
      usmc: t('popups.militaryFlight.operators.usmc'),
      usa: t('popups.militaryFlight.operators.usa'),
      raf: t('popups.militaryFlight.operators.raf'),
      rn: t('popups.militaryFlight.operators.rn'),
      faf: t('popups.militaryFlight.operators.faf'),
      gaf: t('popups.militaryFlight.operators.gaf'),
      plaaf: t('popups.militaryFlight.operators.plaaf'),
      plan: t('popups.militaryFlight.operators.plan'),
      vks: t('popups.militaryFlight.operators.vks'),
      iaf: t('popups.militaryFlight.operators.iaf'),
      nato: t('popups.militaryFlight.operators.nato'),
  ...
  private renderMilitaryVesselPopup(vessel: MilitaryVessel): string {
    const operatorLabels: Record<string, string> = {
      usn: t('popups.militaryVessel.operators.usn'),
      uscg: t('popups.militaryVessel.operators.uscg'),
      rn: t('popups.militaryVessel.operators.rn'),
      fn: t('popups.militaryVessel.operators.fn'),
      plan: t('popups.militaryVessel.operators.plan'),
      ruf: t('popups.militaryVessel.operators.ruf'),
      jmsdf: t('popups.militaryVessel.operators.jmsdf'),
      rokn: t('popups.militaryVessel.operators.rokn'),
      other: t('popups.unknown'),
    };
    const typeLabels: Record<string, string> = {
      carrier: t('popups.militaryVessel.types.carrier'),
      destroyer: t('popups.militaryVessel.types.destroyer'),
      frigate: t('popups.militaryVessel.types.frigate'),
      submarine: t('popups.militaryVessel.types.submarine'),
      amphibious: t('popups.militaryVessel.types.amphibious'),
      patrol: t('popups.militaryVessel.types.patrol'),
      auxiliary: t('popups.militaryVessel.types.auxiliary'),
      research: t('popups.militaryVessel.types.research'),
      icebreaker: t('popups.militaryVessel.types.icebreaker'),
      special: t('popups.militaryVessel.types.special'),
      unknown: t('popups.unknown'),
    };
