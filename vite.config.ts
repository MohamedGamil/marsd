  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "Marsd"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "Marsd"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/marsd\.app\/"/, `"url": "${activeMeta.url}"`)
...
function sebufApiPlugin(): Plugin {
  ...
  async function buildRouter() {
    const [
      ...
      import('./src/generated/server/marsd/seismology/v1/service_server'),
      import('./server/marsd/seismology/v1/handler'),
      import('./src/generated/server/marsd/wildfire/v1/service_server'),
      import('./server/marsd/wildfire/v1/handler'),
      import('./src/generated/server/marsd/climate/v1/service_server'),
      import('./server/marsd/climate/v1/handler'),
      import('./src/generated/server/marsd/prediction/v1/service_server'),
      import('./server/marsd/prediction/v1/handler'),
      import('./src/generated/server/marsd/displacement/v1/service_server'),
      import('./server/marsd/displacement/v1/handler'),
      import('./src/generated/server/marsd/aviation/v1/service_server'),
      import('./server/marsd/aviation/v1/handler'),
      import('./src/generated/server/marsd/research/v1/service_server'),
      import('./server/marsd/research/v1/handler'),
      import('./src/generated/server/marsd/unrest/v1/service_server'),
      import('./server/marsd/unrest/v1/handler'),
      import('./src/generated/server/marsd/conflict/v1/service_server'),
      import('./server/marsd/conflict/v1/handler'),
      import('./src/generated/server/marsd/maritime/v1/service_server'),
      import('./server/marsd/maritime/v1/handler'),
      import('./src/generated/server/marsd/cyber/v1/service_server'),
      import('./server/marsd/cyber/v1/handler'),
      import('./src/generated/server/marsd/economic/v1/service_server'),
      import('./server/marsd/economic/v1/handler'),
      import('./src/generated/server/marsd/infrastructure/v1/service_server'),
      import('./server/marsd/infrastructure/v1/handler'),
      import('./src/generated/server/marsd/market/v1/service_server'),
      import('./server/marsd/market/v1/handler'),
      import('./src/generated/server/marsd/news/v1/service_server'),
      import('./server/marsd/news/v1/handler'),
      import('./src/generated/server/marsd/intelligence/v1/service_server'),
      import('./server/marsd/intelligence/v1/handler'),
      import('./src/generated/server/marsd/military/v1/service_server'),
      import('./server/marsd/military/v1/handler'),
      import('./src/generated/server/marsd/positive_events/v1/service_server'),
      import('./server/marsd/positive-events/v1/handler'),
      import('./src/generated/server/marsd/giving/v1/service_server'),
      import('./server/marsd/giving/v1/handler'),
      import('./src/generated/server/marsd/trade/v1/service_server'),
      import('./server/marsd/trade/v1/handler'),
      import('./src/generated/server/marsd/supply_chain/v1/service_server'),
      import('./server/marsd/supply-chain/v1/handler'),
      import('./src/generated/server/marsd/natural/v1/service_server'),
      import('./server/marsd/natural/v1/handler'),
    ]);
