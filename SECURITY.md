...
If you discover a security vulnerability in Marsd, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/MohamedGamil/marsd/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@MohamedGamil](https://github.com/MohamedGamil) directly through GitHub.
...
Marsd is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Marsd aggregates publicly available OSINT data
...
- Vulnerabilities in the Marsd codebase
...
Thank you for helping keep Marsd and its users safe! 🔒
