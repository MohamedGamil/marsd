...
Comprehensive data model documentation for **Marsd** — an AI-powered real-time global intelligence dashboard. This reference covers all TypeScript interfaces, data structures, and their relationships across the system.
...
|-----|----------|--------------|
| `marsd-panel-spans` | `PANEL_SPANS_KEY` | `Record<string, number>` — panel ID → grid span (1–4) |
...
- Key prefix: `marsd-persistent-cache:`
