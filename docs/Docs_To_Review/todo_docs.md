...
- [ ] Nginx configuration (reference `deploy/nginx-marsd.conf`)
- [ ] SystemD service setup (reference `deploy/marsd-api.service`)
...
- [ ] Add entries for UI customizations on `feat/ui-customizations-marsd` branch
