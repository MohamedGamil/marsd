...
> Comprehensive reference for every external API consumed by Marsd.
...
Marsd integrates **38 distinct external API sources** (plus ~150 RSS feed
...
How Marsd behaves when each external API is unavailable:
