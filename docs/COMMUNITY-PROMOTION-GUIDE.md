# Marsd — Community Promotion Guide

Thank you for helping spread the word about Marsd! This guide provides talking points, must-see features, and visual suggestions to help you create compelling content for your audience.
...
**Longer description**: Marsd aggregates 170+ news feeds, military tracking, financial markets, conflict data, protest monitoring, satellite imagery, and AI-powered analysis into a single unified dashboard with an interactive globe. Available as a web app, desktop app (macOS/Windows/Linux), and installable PWA.
...
| Link | Description |
|------|-------------|
| [marsd.app](https://marsd.app) | Main dashboard — geopolitics, military, conflicts |
| [tech.marsd.app](https://tech.marsd.app) | Tech variant — startups, AI/ML, cybersecurity |
| [finance.marsd.app](https://finance.marsd.app) | Finance variant — markets, exchanges, central banks |
| [GitHub](https://github.com/MohamedGamil/marsd) | Source code (AGPL-3.0) |
...
- **Name**: "Marsd" (two words, capitalized)
- **Tagline**: "Real-time global intelligence dashboard"
- **License**: AGPL-3.0 (free and open source)
- **Creator**: Credit "Marsd by Elie Habib" or link to the GitHub repo
...
We genuinely appreciate community members helping grow Marsd's reach. Feel free to interpret these guidelines creatively — there's no strict template. The most compelling content comes from showing what YOU find most interesting or useful about the tool.
