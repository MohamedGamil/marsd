...
🌐 **[Live Demo: marsd.app](https://marsd.app)** | 💻 **[Tech Variant: tech.marsd.app](https://tech.marsd.app)**
...
Marsd runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Marsd** | [marsd.app](https://marsd.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.marsd.app](https://tech.marsd.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.marsd.app](https://tech.marsd.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that Marsd users may depend on.
...
// App.ts
const header = `Marsd v${__APP_VERSION__}`;
```
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between Marsd and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/marsd.git
   cd marsd
   ```
...
2. Implement the handler in `server/marsd/{domain}/v1/`
