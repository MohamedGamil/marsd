 ...
 *
 * Requires: Referer header from trusted origin OR X-Marsd-Key header.
 * Uses api.marsd.app by default.
 */
...
const API_KEY = process.env.MARSD_KEY || '';
